<?php
    ...
    echo"    <div class='col s10'>";
        ...
        echo "<br>";
          ...
          echo"   </span>";
          echo " <b>Graduação:</b> Faixa ".$graduacao."   &nbsp;&nbsp;  <img src='../img/".$graduacao.".png' alt='' class='square responsive-img' width='30' height='30'><br>";
          echo "<a href='https://api.whatsapp.com/send?1=pt_BR&phone=55".$whatsapp."' target='_blank'>Conversar</a><br>";
          echo "<a href='dashboard.php?id=".$id." target='_blank'>Ver aulas</a>";
